      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <a href="#testimonials" className="font-medium text-gray-700 hover:text-secondary transition-colors">Testimonials</a>
        ...
        {isMenuOpen && (
          <div className="md:hidden py-4 pt-2 animate-fade-in">
            <nav className="flex flex-col space-y-4">
              ...
              <a href="#testimonials" className="font-medium text-gray-700 hover:text-secondary transition-colors" onClick={toggleMenu}>Testimonials</a>
